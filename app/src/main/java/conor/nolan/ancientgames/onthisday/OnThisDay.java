...
import conor.nolan.ancientgames.onthisday.RSS.Entry;
import conor.nolan.ancientgames.onthisday.RSS.StackOverflowXmlParser;

public class OnThisDay extends AppCompatActivity {
    String URL = "https://www.history.com/.rss/excerpt/this-day-in-history";
